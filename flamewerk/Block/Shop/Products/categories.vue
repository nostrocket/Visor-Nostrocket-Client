...
<div class="relative bg-white dark:bg-gray-900">
  ...
  <div aria-hidden="true" class="hidden absolute inset-0 sm:flex sm:flex-col">
    ...
    <div class="w-full bg-white dark:bg-gray-900 h-32 md:h-40 lg:h-48"></div>
  </div>
  ...
  <section aria-labelledby="collection-heading" class="-mt-96 relative sm:mt-0">
    ...
    <div class="max-w-md mx-auto grid grid-cols-1 gap-y-6 px-4 sm:max-w-7xl sm:px-6 sm:grid-cols-3 sm:gap-y-0 sm:gap-x-6 lg:px-8 lg:gap-x-8">
      <div class="group relative h-96 bg-white rounded-lg shadow-xl sm:h-auto sm:aspect-w-4 sm:aspect-h-5 dark:bg-gray-900">
        <div>
          <div aria-hidden="true" class="absolute inset-0 rounded-lg overflow-hidden">
            <div class="absolute inset-0 overflow-hidden group-hover:opacity-75">
              <img src="https://tailwindui.com/img/ecommerce-images/home-page-04-collection-01.jpg" alt="Woman wearing an off-white cotton t-shirt." class="w-full h-full object-center object-cover">
            </div>
      ...
      <div class="group relative h-96 bg-white rounded-lg shadow-xl sm:h-auto sm:aspect-w-4 sm:aspect-h-5 dark:bg-gray-900">
        <div>
          <div aria-hidden="true" class="absolute inset-0 rounded-lg overflow-hidden">
            <div class="absolute inset-0 overflow-hidden group-hover:opacity-75">
              <img src="https://tailwindui.com/img/ecommerce-images/home-page-04-collection-02.jpg" alt="Man wearing a charcoal gray cotton t-shirt." class="w-full h-full object-center object-cover">
            </div>
            <div class="absolute inset-0 bg-gradient-to-b from-transparent to-black opacity-50"></div>
          </div>
          <div class="absolute inset-0 rounded-lg p-6 flex items-end">
