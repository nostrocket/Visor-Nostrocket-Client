<template>
    <div class="dark:text-white my-12">
...
const onSubmit = () => {
    nostrkeys.nostr.sk = 'Just A Test';

    nostrkeys.nostr.pkhex = 'c8383d81dd24406745b68409be40d6721c301029464067fcc50a25ddf9139549';
