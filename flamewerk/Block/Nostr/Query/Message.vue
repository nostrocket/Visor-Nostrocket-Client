<template>
  ...
  <div class="bg-white shadow sm:rounded-lg max-w-4xl mx-auto  dark:bg-gray-800 my-2">
    <div class="px-4 py-5 sm:p-6">
      <h3 class="text-base font-semibold leading-6 text-gray-900 dark:text-white"><MapPinIcon class="h-6 w-6 mr-1 -mt-2 inline" /> Pinned Flamewerk Nostr Message</h3>
...
let sub = relay.sub([
  {
    ids: ['afb961bf976f449f7d1be9f9b2eeeccf6ca71739bc7cb020e50ed1710dd1b5bc']
  }
])
sub.on('event', event => {
