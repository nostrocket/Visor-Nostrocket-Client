<template>
          ...
          <form action="#" class="relative my-12">
            <div
            ...
            >
              ...
              <input
                ...
                name="title"
                id="title"
                class="block w-full border-0 pt-2.5 text-lg font-medium placeholder:text-gray-400 focus:ring-0 px-2"
              ...
              <textarea
                ...
                name="description"
                id="description"
                class="block w-full resize-none border-0 py-0 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6 px-2"
              ...
              >
                <Listbox as="div" v-model="assigned" class="flex-shrink-0">
                  ...
                  <div class="relative">
                    ...
                    >
                      <ListboxOptions
                        class="absolute left-0 right-0 z-10 mt-1 max-h-56 w-52 overflow-auto rounded-lg bg-white py-3 text-base shadow ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm"
                      >
                        <ListboxOption
                          as="template"
