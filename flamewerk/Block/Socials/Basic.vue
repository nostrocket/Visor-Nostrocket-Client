...
<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	 class="h-7 w-7 fill-colorHighLight hover:fill-colorHoverHighLight dark:fill-colorHighDark hover:fill-colorHoverHighDark" viewBox="0 0 875 875" style="enable-background:new 0 0 875 875;" xml:space="preserve">
