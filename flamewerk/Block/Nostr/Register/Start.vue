<template>
    <div class="dark:text-white">
      ...
      <h1 class="text-3xl text-left"><IdentificationIcon class="h-10 w-10 mr-2 inline " />Register Keys</h1>

      <p>{{ t("title") }} </p>



      <h1 class="text-3xl text-left mt-6">Bech32 Format</h1>
      ...
      <button @click="newpair" class="max-w-sm mx-auto flex w-full items-center justify-center rounded-md border border-transparent px-4 py-2 text-base font-medium text-white shadow-sm bg-colorBtnLight dark:bg-colorBtnDark dark:hover:bg-colorBtnHoverDark hover:bg-colorBtnHoverLight"> {{ t("button") }}</button>



      <h1 class="text-3xl text-left mt-6">HEX Format</h1>
