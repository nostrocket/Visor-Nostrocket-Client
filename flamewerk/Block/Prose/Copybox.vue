<template>
  <div class="container relative max-w-4xl mt-4 bg-gray-800 dark:bg-gray-400 text-left rounded-lg
  
  
  ">
    <p id="#code" class="text-white px-2 py-3 truncate"> {{copycontent}} </p>
    <button
      ref="copy"
