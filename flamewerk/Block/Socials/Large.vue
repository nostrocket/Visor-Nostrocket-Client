<template>
  <div class="max-w-fit mx-auto mt-6">
    ...
    <a
      v-if="project.$state.socialnavigation.telegram"
      :href="project.$state.socialnavigation.telegram"
      target="_blank"
      class="text-colorHighLight hover:text-colorHoverHighLight dark:text-colorHighDark dark:hover:text-colorHoverHighDark inline-block mx-3"
    >
      ...
      <svg
        ...
        viewBox="0 0 24 24"
      >
<path class="h-6 w-6" d="M12,2C6.5,2,2,6.5,2,12s4.5,10,10,10s10-4.5,10-10S17.5,2,12,2z M16.9,8.1l-1.7,8.2c-0.1,0.6-0.5,0.7-0.9,0.4l-2.6-2
    ...
    <a
      v-if="project.$state.socialnavigation.nostr"
      :href="project.$state.socialnavigation.nostr"
      target="_blank"
      class="text-colorHighLight hover:text-colorHoverHighLight dark:text-colorHighDark dark:hover:text-colorHoverHighDark inline-block mx-3"
    >
...
<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	 class="h-8 w-8 fill-colorHighLight hover:fill-colorHoverHighLight dark:fill-colorHighDark hover:fill-colorHoverHighDark" viewBox="0 0 875 875" style="enable-background:new 0 0 875 875;" xml:space="preserve">
